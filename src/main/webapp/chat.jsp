...
<html lang="en" ng-app="chatApplication">
    ...
    <body ng-controller="ChatController">
        ...
        <div id="chat-panel">
            <label class="chat-label">Bem vindo(a) ao chat, {{user}}</label>
            ...
            <span class="message-count-label">
                <strong>{{messages.length}}</strong> <ng-pluralize count="messages.length" when="{ one: 'mensagem', other: 'mensagens' }"></ng-pluralize> no chat
            </span>
            <form ng-submit="send()">
                <input class="textbox" placeholder="Digite Aqui!"
